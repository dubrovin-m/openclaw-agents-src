...
bash -n "$ROOT/tests/compatibility-window.sh"
bash -n "$ROOT/tests/current-predecessor-deploy.sh"
...
test -f "$ROOT/tests/compatibility-window.sh"
test -f "$ROOT/tests/current-predecessor-deploy.sh"
...
bash "$ROOT/tests/compatibility-window.sh" "$ROOT/taskctl"
bash "$ROOT/tests/current-predecessor-deploy.sh"
