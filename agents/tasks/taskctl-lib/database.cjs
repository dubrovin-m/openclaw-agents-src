...
const {
  fs, path, DatabaseSync, contacts, contactStore,
  IMPLEMENTATION_VERSION, SCHEMA_VERSION, TZ, SELF_NAME, DB_PATH,
  AppError, ci, localDate, localTime,
} = require('./runtime.cjs');
...
module.exports = { openDb, openReadDb, healthSnapshot };
